...
const I18N = {
  vi: {
    ...
    sens_modal_hint: "Chạy lại mô hình nhiều lần, mỗi lần bỏ ngẫu nhiên thêm N quan sát so với lần trước, đến khi số quan sát còn khoảng 50 — giúp đánh giá cỡ mẫu tối thiểu và độ ổn định của kết quả. Dữ liệu hiện có {n} quan sát.",
  ...
  en: {
    ...
    sens_modal_hint: "Re-runs the model repeatedly, each time randomly dropping N more observations than the last, until about 50 remain — helps gauge the minimum viable sample size and how stable the results are. The data currently has {n} observations.",
