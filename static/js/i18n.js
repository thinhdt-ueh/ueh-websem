...
const I18N = {
  vi: {
    ...
    ml_comparison_hint: "Bảng bên dưới gộp tất cả các biến mục tiêu vào một bảng duy nhất (nhóm theo cột \"Biến mục tiêu\"). Cột \"SEM\" là hệ số đường dẫn chuẩn hóa từ mô hình cấu trúc; các cột thuật toán là permutation importance. Biểu đồ minh họa cùng số liệu, chuẩn hóa 0–1 riêng theo từng biến mục tiêu để dễ so sánh trực quan.",
  ...
  en: {
    ...
    ml_comparison_hint: "The table below merges every target construct into one table (grouped by the \"Target\" column). The \"SEM\" column is the standardized path coefficient from the structural model; the algorithm columns are permutation importance. The charts show the same figures, normalized 0–1 within each target for an easier visual comparison.",
