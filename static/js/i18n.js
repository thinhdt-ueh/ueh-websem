...
const I18N = {
  vi: {
    ...
    exp_groups_hint: "Mỗi nhóm có một điều kiện (prompt) khác nhau; tổng số Worker của các nhóm phải bằng M. Tối đa 6 nhóm.",
    exp_groups_col_condition: "Điều kiện (prompt)",
  ...
  en: {
    ...
    exp_groups_hint: "Each group has its own condition (prompt); the groups' sizes must sum to M. Up to 6 groups.",
    exp_groups_col_condition: "Condition (prompt)",
