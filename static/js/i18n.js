...
const I18N = {
  vi: {
    ...
    s2_ai_moderator_suggestions_hint: "Sau khi chuyển, hãy chọn construct đó trên sơ đồ để gán 2 biến nguồn cho tương tác.",
  ...
  en: {
    ...
    s2_ai_moderator_suggestions_hint: "After converting, select that construct on the canvas to assign its two interaction source constructs.",
