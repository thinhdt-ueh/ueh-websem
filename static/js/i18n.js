...
const I18N = {
  vi: {
    ...
    ai_modal_api_key_label: "OpenAI API key của bạn",
    ai_modal_api_key_hint: "Key được gửi tới máy chủ đang chạy app này để chuyển tiếp yêu cầu tới OpenAI cho đúng 1 lần gọi này — không được lưu trữ hay ghi log ở phía máy chủ.",
    ...
    ai_loading: "Đang sinh báo cáo bằng AI — có thể mất khoảng 30-90 giây tuỳ độ dài yêu cầu…",
  ...
  en: {
    ...
    ai_modal_api_key_label: "Your OpenAI API key",
    ai_modal_api_key_hint: "The key is sent to this app's own server to relay this one request to OpenAI — it is never stored or logged server-side.",
    ...
    ai_loading: "Generating the report with AI — this may take about 30-90 seconds depending on length…",
